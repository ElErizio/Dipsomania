...
public class PlayerSkin : MonoBehaviour
{
    ...
    {
        if (_skin == SKIN_SELECTED.BASICO)
        {
            GetComponent<MeshRenderer>().material = skins[0];
        }
        else if (_skin == SKIN_SELECTED.NEGRO)
        {
            GetComponent<MeshRenderer>().material = skins[1];
        }
        else if (_skin == SKIN_SELECTED.RUBIO)
        {
            GetComponent<MeshRenderer>().material = skins[2];
        }
        else if (_skin == SKIN_SELECTED.JOKER)
        {
            GetComponent<MeshRenderer>().material = skins[3];
        }
    }
